...
//import AudioRecorder.CaptureThread;
...
import digicaapplet.AudioProcessingFile;
...
public class DigicaApplet extends PApplet {
	...
	public AudioProcessingFile audio;
...
/*	public void setup()
	{
		...
		//targetFile = new File("C:/fakepath/online." + AudioFileFormat.Type.WAVE.getExtension());
	...
	public void setupPlayer()
	{
		...
		try {
			...
			//URL audiourl = new URL("file:/E:/My Stuff/Web Design/DigicaApplet/online.wav");
			audio = new AudioProcessingFile(targetFile);
...
/*	public void draw()
	...
	*/
	...
	private void captureAudio() {       
	    try {
	    	// The format should be the same, so ingore
	        DataLine.Info dataLineInfo = new DataLine.Info(
	                TargetDataLine.class, targetFormat);
	...
	class CaptureAudioThread extends Thread {
	    ...
	    public void run() {
        	//outputstream = new ByteArrayOutputStream();
        	AudioFileFormat.Type fileType = AudioFileFormat.Type.WAVE;
        	File audioFile = new File("C:/fakepath/audiorecorded." + fileType.getExtension());
	        ...
	        try {
	            ...
	            //AudioSystem.write(new AudioInputStream(targetline), AudioFileFormat.Type.WAVE, targetFile);
	        	AudioSystem.write(new AudioInputStream(targetline), fileType, audioFile);
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
	    }
...
/*		    		stroke(93, 93, 0);
		    	...
		    	lue.printStackTrace();
		    	System.err.println("TargetLine unavailable!!");
		    }
		}
	}
